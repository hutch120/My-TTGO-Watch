...
/**
        ...
        log_i("power wakeup: Heap: %d, PSRAM: %d, uptime: %d", ESP.getFreeHeap(), ESP.getFreePsram(), millis() / 1000);
    }
    else if (powermgm_get_event(POWERMGM_STANDBY_REQUEST))
    {
         ...
         */
        log_i("power standby: Heap: %d, PSRAM: %d, uptime: %d", ESP.getFreeHeap(), ESP.getFreePsram(), millis() / 1000);
